...
@FactAnalyzerAnnotations(
        name = "SpringAnnotationFactAnalyzer"
)
public class SpringAnnotationFactAnalyzer extends SpringFactAnalyzer{
    ...
    public SpringAnnotationFactAnalyzer(String name, String type, String description) {
        super(name, type, description);
    }

    public SpringAnnotationFactAnalyzer(){
        super(SpringAnnotationFactAnalyzer.class.getName(), "class", "");
    }
